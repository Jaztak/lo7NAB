void((function lo7NAB(doc) {
  ...
  function displayOverlay() {
    ...
    $("<div id='overlay-7'><tbody><tr><td></td></tr></tbody></div>").css({
      "position": "fixed",
      "top": 36,
      "left": 69,
      "width": 15,
      "height": 15,
      "background-color": "rgba(190, 218, 235, 0.9)",
      "z-index": 10000,
      "color": "#000000",
      "font-family": "Georgia, serif",
      "font-size": "10px",
    ...
    $("<div id='overlay-8'><tbody><tr><td></td></tr></tbody></div>").css({
      "position": "fixed",
      "top": 36,
      "left": 86,
      "width": 15,
      "height": 15,
      "background-color": "rgba(199, 74, 12, 0.9)",
      "z-index": 10000,
      "color": "#000000",
      "font-family": "Georgia, serif",
      "font-size": "10px",
    ...
    $("<div id='overlay-9'><tbody><tr><td></td></tr></tbody></div>").css({
      "position": "fixed",
      "top": 53,
      "left": 69,
      "width": 15,
      "height": 15,
      "background-color": "rgba(31, 199, 12, 0.9)",
      "z-index": 10000,
      "color": "#000000",
      "font-family": "Georgia, serif",
      "font-size": "10px",
    ...
    $("<div id='overlay-10'><tbody><tr><td></td></tr></tbody></div>").css({
      "position": "fixed",
      "top": 53,
      "left": 86,
      "width": 15,
      "height": 15,
      "background-color": "rgba(242, 217, 27, 0.9)",
      "z-index": 10000,
      "color": "#000000",
      "font-family": "Georgia, serif",
      "font-size": "10px",
  ...
  function makeItFall(snow) {
    ...
    sizeChoices = ['xx-small', 'x-small', 'small', 'medium', 'large', 'large', 'x-large'];
  ...
  function shapeChanger() {
    var color = prompt("what color should the shape be?");
    var roundness = prompt("how round should the shape be? (0 to 100)");
    roundness = roundness / 2;
    document.body.onmousedown = function(e) {
      if (clickInElement(e)) {
        alert("not on the lo7NAB!");
      } else {
        var firstx = e.pageX;
        alert(firstx);
      }
  ...
  function cpsslow() {
    ...
    function autoClick(element) {
      var inElement = clickInElement(element);
      if (element.classList.contains("auto-clicker-target") && !inElement) {
        element.click();
        setTimeout(function() {
          autoClick(element);
        }, DELAY);
  ...
  function cpsfast() {
    ...
    function autoClick(element) {
      var inElement = clickInElement(element);
      if (element.target.classList.contains("auto-clicker-target") && !inElement) {
        element.click();
        element.click();
        element.click();
        element.click();
  ...
  function autoClickBig(e) {
    ...
    var inElement = clickInElement(e);
    if (!inElement) {
      element.click();
      element.click();
      element.click();
  ...
  function shell() {
    void((function(doc) {
      ...
      function Bing() {
        ...
        $("<iframe scrolling='no' width='1300px' height='700px' id='bing-frame2' src='https://www.bing.com/' allowfullscreen='allowfullscreen' allowpaymentrequest frameborder='0' hidden='hidden'</iframe>").css({
          "position": "fixed",
          "z-index": 214748360,
          "top": "6vh",
          "left": "0vw"
        }).appendTo("body");
        $("<iframe scrolling='no' width='1300px' height='700px' id='bing-frame3' src='https://www.bing.com/' allowfullscreen='allowfullscreen' allowpaymentrequest frameborder='0' hidden='hidden'</iframe>").css({
          "position": "fixed",
          "z-index": 214748360,
          "top": "6vh",
          "left": "0vw"
      ...
      function doStuff() {
        ...
        $(this).keypress(function(event) {
          if (event.keyCode == 13) {
            ...
            if (Val.includes("fuck") || Val.includes("Fuck") || Val.includes("shit") || Val.includes("Shit") || Val.includes("dick") || Val.includes("Dick") || Val.includes("bitch") || Val.includes("Bitch") || Val.includes("69") || Val.includes("420") || Val.includes("fag") || Val.includes("faggot")) {
  ...
  fall.addEventListener('click', makeItFall);
